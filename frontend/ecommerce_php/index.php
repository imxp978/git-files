...
<body>
  ...
  <section id="categories">
    <div class="container px-5 text-center" py-5>
      ...
      <div class="row my-3">
        <div class="card col-sm-12 col-md-6 col-lg-4 border-0 gx-5 gy-5 movable slideIn" v-for="item in categories"
          :key="item.id">
          <div class="card-image">
            ...
            <div class="category-image">
              <a href="#"><img :src="`/images/category_images/${item.image}`" class="card-img-top" alt="..." /></a>
            </div>
          </div>
          <div class="card-body">
  ...
  <?php $SQLstring="SELECT * FROM reviews";
          ...
          <div class="row g-5">
            ...
            <div class="col-md-8">
              <div class="card-body text-start">
                ...
                <?php } ?>
                <p class="card-text">review.content<?php echo $data['content']; ?></p>
                <p class="card-text">
