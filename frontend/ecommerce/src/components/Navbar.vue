          ...
          <div class="collapse navbar-collapse bg-light" id="navbarSupportedContent">
              ...
              <div class="d-flex justify-content-lg-end justify-content-end text-end">
                <ul class="navbar-nav  mb-2">
                  ...
                  <a class="nav-link" href="#" @click="searchShow"><i class="fa-solid fa-magnifying-glass fa-4"></i></a>
                </li>
                <li class="d-flex justify-content-end">
                  <a class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#login"><i class="fa-solid fa-user fa-4"></i></a>
                </li>
                <li class="d-flex justify-content-end">
                  <a class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#cart"><i class="fa-solid fa-cart-shopping fa-4"></i></a>
                </li>
                </ul>
              </div>
          </div>
