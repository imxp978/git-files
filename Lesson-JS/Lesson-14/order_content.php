<?php
    ...
    WHERE ms2.msid=uorder.status AND ms1.msid=uorder.howpay AND uorder.emailid=%d AND uorder.addressid=addbook.addressid 
                                                    ...
                                                    <tbody>
                                                        <?php while ($cart_data = $cart_rs->fetch()) { ?>
                                                            <tr>
                                                                ...
                                                                <td><img src="product_img/<?php echo $cart_data['img_file']; ?>" class="img-fluid" alt="<?php echo $cart_data['p_name']; ?>" class="img-fluid"></td>
