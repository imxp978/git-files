<?php
                    ...
                    <?php if ($cart_rs->rowCount() != 0) { ?>
                        <a href="index.php"><button type="button" id="btn01" class="btn btn-primary">繼續購物</button></a>
                        <button type="button" id="btn02" class="btn btn-info" onclick="window.history.go(-1)">回到上一頁</button>
                        <button type="button" id="btn03" class="btn btn-success" onclick="btn_confirmLink('確定清空購物車?','shopcart_del.php?mode=2')">清空購物車</button>
                        <a href="checkout.php" id="btn04" class="btn btn-warning">前往結帳</a>
                                        ...
                                        <tr>
                                            ...
                                            <td style="min-width:100px;">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" id="qty[]" name="qty[]" value="<?php echo $cart_data['qty']; ?>" min="1" max="49" cartid="<?php echo $cart_data['cartid']; ?>" style="min-width:60px" required>
                                                </div>
                                            </td>
                                            <td>$<?php echo $cart_data['p_price'] * $cart_data['qty']; ?></td>
                                            <td><button class="btn btn-danger" type="button" id="btn[]" name="btn[]" onclick="btn_confirmLink('確定刪除本資料?','shopcart_del.php?mode=1&cartid=<?php echo $cart_data['cartid']; ?>');">取消</button></td>
                                        </tr>
