...
if (isset($_GET['p_id']) && $_GET['p_id'] != '') {
  ...
  $level1 = $data['uplevel'];
  $level1Open = '<li class="breadcrumb-item active"><a href="drugstore.php?classid=' . $level1Upclassid . '&level=' . $level1 . '">' . $level1Cname . '</a></li>';

  // 第二層
  $level2Cname = $data['cname'];
  $level2Classid = $data['classid'];
  $level2Open = '<li class="breadcrumb-item active"><a href="drugstore.php?classid=' . $level2Classid . '">' . $level2Cname . '</a></li>';
  ...
  $level1Cname = $data['cname'];
  $level1 = $data['level'];
  $level1Open = '<li class="breadcrumb-item active"><a href="drugstore.php?classid=' . $level2Uplink . '&level=' . $level1 . '">' . $level1Cname . '</a></li>';
}
?>
