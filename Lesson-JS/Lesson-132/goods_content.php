      ...
      <div class="row mt-2">
        ...
        <?php do { ?>
          ...
          <div class="col-md-4">
            ...
            <img src="./product_img/<?php echo $imgList['img_file']; ?>" alt="<?php echo $imgList['p_name']; ?>" title="<?php echo $imgList['p_name']; ?>" class="img-fluid">
          </a>
          </div>
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-6">
            ...
            <div class="input-group input-group-lg">
              ...
              <input type="text" id="qty" name="qty" value="1" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg">
          ...
          <div class="col-md-6">
            <button name="buton01" id="button01" type="button" class="btn btn-success btn-lg color-success" onclick="addcart(<?php echo $data['p_id'] ?>)">加入購物車</button>
