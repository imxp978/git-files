...
<table width="600" border="1" align="center" cellpadding="1" cellspacing="1">
  <tr>
    <td><a href="index.php"></a>      <div align="right"><a href="post.php">發表主題</a>　<a href="search.php">搜尋</a></div></td>
  </tr>
</table>
<br />
<table width="600" border="1" align="center" cellpadding="1" cellspacing="1">
  <tr>
    <td width="350" bgcolor="#3366CC"><font color="#FFFFFF">主題</font></td>
    <td width="100" bgcolor="#3366CC"><font color="#FFFFFF">發表人</font></td>
    <td width="150" bgcolor="#3366CC"><font color="#FFFFFF">時間</font></td>
  </tr>
  <?php do { ?>
    <tr>
      <td width="350"><a href="topic.php?TopicID=<?php echo $row_Recordset1['TopicID']; ?>"><?php echo $row_Recordset1['Title']; ?></a></td>
      <td width="100"><?php echo $row_Recordset1['Nickname']; ?></td>
      <td width="150"><?php echo $row_Recordset1['Time']; ?></td>
    </tr>
