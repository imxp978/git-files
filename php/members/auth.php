...
//為了這邊的判斷所以用刪除記錄改 而不直接用修改紀錄
if ((isset($_GET['Username'])) && ($_GET['Username'] != "")) {
  $deleteSQL = sprintf("UPDATE member SET State=1 WHERE Username=%s AND Authcode=%s",
  ...
  $Result1 = mysql_query($deleteSQL, $members_conn) or die(mysql_error());
