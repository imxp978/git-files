...
if (isset($_POST['Username'])) {
  ...
  $LoginRS__query=sprintf("SELECT Username, Password, State FROM member WHERE Username=%s AND Password=%s",
...
<table align="center" width="25%" class="table-sm table-striped table-bordered border-primary">
  ...
  <tr>
    <td><label>使用者名稱: </label>
      <input name="Username" type="text" class="form-control" /></td>
  </tr>
  <tr>
    <td><label>密 碼: </label>
      <input name="Password" type="password" class="form-control" /></td>
  </tr>
  <tr>
    <td><input name="Authcode" type="hidden" value="Authcode" />
      <a href="reg.php">帳號註冊</a>
